...
contract MarketPlaceTest is DSTest {
    ...
    function testCreatNFTRevertThisShouldAsWellNotWork()public{
        vm.startPrank(users[0]);
        Struct.NFTData memory t1 = Struct.NFTData({ winery:users[1],releaseDate: 11690768,amount:11,royaltyAmount:10,URI:"NFTOne"});
        market.createNFT(t1);
        vm.stopPrank();
    }
    ...
    function testBuyNFTsecondary() public//secondary sell
    {
      ...
      usdc.approve(address(market), 100000);
        ...
        usdc.approve(address(market),100000000000000000000000000000);
        vm.warp(1689183652);
